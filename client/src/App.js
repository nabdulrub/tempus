...
function App() {
  ...
  return (
    <div className="flex h-[100vh] w-[100vw] items-center justify-center bg-white p-[50px]">
      <div className="flex h-full max-w-[1440px] flex-col gap-10 overflow-hidden rounded-3xl bg-background-color px-[30px] py-[40px]">
        <header>
          <Navbar
            setCity={setCity}
            city={city}
        ...
        <body>
          ...
          <div className="col-start-4 row-span-2">
            <div className="flex flex-col gap-6 ">
              <div className="text-2xl text-text-white">Chance of Rain</div>
              <BarChart rainData={rainData} />
            </div>
            <div className="flex flex-col gap-6">
              <h2 className="text-2xl text-text-white">Popular cities</h2>
